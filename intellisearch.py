...
class IntelliSearch:
                ...
                for source in sources:
                    if isinstance(source, dict):
                        ...
                        <div class="result-card">
                            ...
                            <div style="margin-top: 1rem; color: #64ffda; font-size: 0.9rem;">
    ...
    async def display_response(self, rag_result: Dict[str, Any]):
        """Display response from RAG System"""
    ...
    async def run(self):
        ...
        if self.system_status:
            ...
            if len(active_caps) >= 3:
                ...
                st.success(f"✨ **IntelliSearch Fully Operational** - {total_articles} space articles indexed | {len(active_caps)} features active | Avg response: {avg_time:.1f}s | Success rate: {success_rate:.0f}%")
